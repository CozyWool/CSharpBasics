...
public class SpecifierShould
{
    ...
    public void GetApiMethodNamesWithDescription()
    {
        ...
        CollectionAssert.AreEquivalent(
                                       ...
                                       {
                                           AuthorizeMethodName,
                                           CountAudioMethodName,
                                           SelectAudioMethodName
                                       },
                                       actual);
    }
    ...
    {
        var description =
            _vkApiSpecifier.GetApiMethodParamDescription(SelectAudioMethodName, Guid.NewGuid().ToString());
        Assert.IsNull(description);
    }
                           ...
                           ParamDescriptions = new[]
                                               {
                                                   ...
                                                   {
                                                       ParamDescription =
                                                           new CommonDescription("batchSize",
