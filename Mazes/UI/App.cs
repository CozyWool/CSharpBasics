...
public partial class App
{
    ...
    private static IEnumerable<TestCase> CreateTestCases()
    {
        ...
        yield return new MazeTestCase("spiral1", SpiralMazeTask.MoveOut);
        yield return new MazeTestCase("spiral2", SpiralMazeTask.MoveOut);
        yield return new MazeTestCase("spiral3", SpiralMazeTask.MoveOut);
        yield return new MazeTestCase("spiral4", SpiralMazeTask.MoveOut);
        yield return new MazeTestCase("spiral5", SpiralMazeTask.MoveOut);
        yield return new MazeTestCase("spiral6", SpiralMazeTask.MoveOut);
    }
}