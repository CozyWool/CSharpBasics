...
{
    public static void ShowHistogram(HistogramData stats, string title, OxyColor? barColor = null)
    {
        ...
        model.Series.Add(new BarSeries
                         {
                             ItemsSource = stats.YValues.Select(v =>
                                                                {
                                                                    var barItem = new BarItem(v);
                                                                    if (barColor.HasValue)
                                                                    {
                                                                        barItem.Color = barColor.Value;
                                                                    }
                           ...
                           GetColorFunc = value =>
                                          {
                                              ...
                                              var color = sigmaValue >= 0
                                                              ? OxyColor.FromArgb(255, (byte) (255 - colorValue), 255,
                                                                   (byte) (255 - colorValue))
                                                              : OxyColor.FromArgb(255, 255, (byte) (255 - colorValue),
                                                                   (byte) (255 - colorValue));
                                              return color;
                                          },
                       });
