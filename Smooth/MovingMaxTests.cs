...
public class MovingMaxTests
{
    ...
    {
        CheckMax(10, [100.0], [100.0]);
    }

    [Test]
    public void TwoValuesIncreasing()
    {
        CheckMax(2, [1, 20.0], [1, 20.0]);
    }

    [Test]
    public void TwoValuesDecreasing()
    {
        CheckMax(2, [10, 0.0], [10, 10.0]);
    }

    [Test]
    public void TwoValuesWithSmallWindow()
    {
        CheckMax(1, [10, 0.0], [10, 0.0]);
    }

    [Test]
    public void WithWindow2()
    {
        CheckMax(2, [1, 2, 5, 1, 0, 6], [1, 2, 5, 5, 1, 6]);
    }

    [Test]
    public void SmoothWithLargeWindow()
    {
        CheckMax(100500, [1, 2, 5, 1, 0, 6], [1, 2, 5, 5, 5, 6]);
    }
